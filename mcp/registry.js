 ...
 *                (${CWD} resolves to the directory where setup ran)
...
const MCP_SERVERS = [
  ...
  },
  {
    id: 'fetch',
    name: 'Fetch',
    description: 'Fetch a URL over HTTP and convert it to markdown/HTML for reading.',
    recommended: false,
    command: 'npx',
    args: ['-y', 'mcp-fetch-server'],
    env: {},
    docs: 'https://github.com/zcaceres/fetch-mcp',
    note: 'Also supports plain text, JSON and YouTube transcripts.',
  },
  {
    id: 'duckduckgo',
    name: 'DuckDuckGo Search',
    description: 'Web search with no API key.',
    recommended: false,
    command: 'npx',
    args: ['-y', 'duckduckgo-mcp-server'],
    env: {},
    docs: 'https://github.com/zhsama/duckduckgo-mcp-server',
    note: 'Community TypeScript server (search only). Pair with fetch for page contents.',
  },
  {
    id: 'git',
    name: 'Git',
    description: 'Local git history, diffs and repo operations — no token needed.',
    recommended: false,
    command: 'npx',
    args: ['-y', '@cyanheads/git-mcp-server'],
    env: { GIT_BASE_DIR: '${GIT_BASE_DIR}' },
    optionalEnv: ['GIT_BASE_DIR'],
    docs: 'https://github.com/cyanheads/git-mcp-server',
    note: 'Requires Node ≥ 20. GIT_BASE_DIR (optional) restricts which repositories it can touch.',
  },
  {
    id: 'filesystem',
    name: 'Filesystem',
    description: 'Read/write access sandboxed to the directory where setup ran.',
    recommended: false,
    command: 'npx',
    args: ['-y', '@modelcontextprotocol/server-filesystem', '${CWD}'],
    env: {},
    docs: 'https://github.com/modelcontextprotocol/servers/tree/main/src/filesystem',
    note: 'Allowed directory is fixed to the setup working dir (${CWD}) to honor least privilege.',
  },
  {
    id: 'sqlite',
    name: 'SQLite',
    description: 'Query a local SQLite database (read + write).',
    recommended: false,
    command: 'npx',
    args: ['-y', '@pollinations/mcp-server-sqlite', '${SQLITE_PATH}'],
    env: {},
    requiredEnv: ['SQLITE_PATH'],
    docs: 'https://github.com/pollinations/mcp-server-sqlite-npx',
    note: 'SQLITE_PATH is a local .sqlite3 file path, not a secret.',
  },
  {
    ...
    note: 'Official TypeScript server.',
  },
  {
    id: 'time',
    name: 'Time',
    description: 'Timezone-aware current time and conversions.',
    recommended: false,
    command: 'npx',
    args: ['-y', '@mcpcentral/mcp-time'],
    env: {},
    docs: 'https://github.com/mcpcentral-io/mcp-time',
    note: 'Community TypeScript server (stdio).',
  },
  {
    id: 'github',
    name: 'GitHub',
