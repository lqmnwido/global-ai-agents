...
const codexSkillsOk = codexSkills.every(
  (s) => s.skill.includes(index.MARKER) && s.skill.includes('name:') && s.policy.includes('allow_implicit_invocation: false') && s.skillPath.endsWith('SKILL.md')
);
if (codexSkillsOk) ok(`codex: ${codexSkills.length} skills generated (${index.codexSkillDir()})`);
else bad('codex skill generator', 'SKILL.md / policy content issue');
...
const markerCases = [
  ...
  ['Auto-generated by @lqmnwido/global-ai-agents v1.4.2', true],
];
